...
var centerMenu = [
    ...
    ,{
        name: '学生成绩',
        url: '../chengji/list.html'
    }
    ,{
        name: '活动报名',
        url: '../huoodngbaoming/list.html'
    }
    ,{
        name: '学生请假',
        url: '../qingjia/list.html'
    }
    ,{
        name: '选课信息',
        url: '../xuanke/list.html'
    }
    ,{
        name: '学分增加记录',
        url: '../xuefenjilu/list.html'
    }
    ,{
        name: '交流申请',
        url: '../jiaoliushenqing/list.html'
    }
]
...
var indexNav = [
    ...
    {
        name: '院校展示',
        url: './pages/yuanxiao/list.html'
    },
    {
        name: '公共资料',
        url: './pages/ziliao/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/benkeshengjiaoliuguanli/admin/dist/index.html#/login";
