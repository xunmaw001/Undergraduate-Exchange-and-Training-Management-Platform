    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="课程时间/分钟" prop="kechengShijian">
                       <el-input v-model="ruleForm.kechengShijian"
                                 placeholder="课程时间/分钟" clearable  :readonly="ro.kechengShijian"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="课程时间/分钟" prop="kechengShijian">
                           <el-input v-model="ruleForm.kechengShijian"
                                     placeholder="课程时间/分钟" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学分" prop="xuefenNumb">
                       <el-input v-model="ruleForm.xuefenNumb"
                                 placeholder="学分" clearable  :readonly="ro.xuefenNumb"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="学分" prop="xuefenNumb">
                           <el-input v-model="ruleForm.xuefenNumb"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.kechengContent"  label="课程详情" prop="kechengContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   kechengShijian: [
                              { required: true, message: '课程时间/分钟不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
