    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="院校名称" prop="yaopinName">
                       <el-input v-model="ruleForm.yaopinName"
                                 placeholder="院校名称" clearable  :readonly="ro.yaopinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="院校名称" prop="yaopinName">
                           <el-input v-model="ruleForm.yaopinName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yaopinPhoto" label="展示照片" prop="yaopinPhoto">
                        <file-upload
                            tip="点击上传展示照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yaopinPhoto" label="展示照片" prop="yaopinPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yaopinContent"  label="展示内容" prop="yaopinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yaopinContent" label="展示内容" prop="yaopinContent">
