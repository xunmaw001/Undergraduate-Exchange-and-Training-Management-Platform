    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩标题" prop="chengjiName">
                       <el-input v-model="ruleForm.chengjiName"
                                 placeholder="成绩标题" clearable  :readonly="ro.chengjiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩标题" prop="chengjiName">
                           <el-input v-model="ruleForm.chengjiName"
                                     placeholder="成绩标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="成绩类型" prop="chengjiTypes">
                        <el-select v-model="ruleForm.chengjiTypes" :disabled="ro.chengjiTypes" placeholder="请选择成绩类型">
                            <el-option
                                v-for="(item,index) in chengjiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="成绩类型" prop="chengjiValue">
                        <el-input v-model="ruleForm.chengjiValue"
                            placeholder="成绩类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="xuenfenNumber">
                       <el-input v-model="ruleForm.xuenfenNumber"
                                 placeholder="成绩" clearable  :readonly="ro.xuenfenNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="成绩" prop="xuenfenNumber">
                           <el-input v-model="ruleForm.xuenfenNumber"
                                     placeholder="成绩" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.chengjiContent"  label="备注" prop="chengjiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chengjiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chengjiContent" label="备注" prop="chengjiContent">
                            <span v-html="ruleForm.chengjiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   chengjiName: [
                              { required: true, message: '成绩标题不能为空', trigger: 'blur' },
                          ],
                   chengjiTypes: [
                              { required: true, message: '成绩类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chengji_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chengjiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.chengjiContent = _this.ruleForm.chengjiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.chengjiContent = this.ruleForm.chengjiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`chengji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chengjiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
