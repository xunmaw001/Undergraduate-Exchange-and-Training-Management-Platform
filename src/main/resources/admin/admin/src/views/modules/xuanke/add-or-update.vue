            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='kecheng' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengPhoto" label="课程封面" prop="kechengPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (kechengForm.kechengPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='kecheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="课程时间/分钟" prop="kechengShijian">
                        <el-input v-model="kechengForm.kechengShijian"
                                  placeholder="课程时间/分钟" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xuanke/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xuankeCrossAddOrUpdateFlag = false;
                                        this.parent.search();
