    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="工号" prop="jiaoshiUuidNumber">
                        <el-input v-model="jiaoshiForm.jiaoshiUuidNumber"
                                  placeholder="工号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="工号" prop="jiaoshiUuidNumber">
                ...
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="教师类型" prop="jiaoshiValue">
                        <el-input v-model="jiaoshiForm.jiaoshiValue"
                                  placeholder="教师类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="教师类型" prop="jiaoshiValue">
                            <el-input v-model="ruleForm.jiaoshiValue"
                                      placeholder="教师类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='jiaoshi' ">
            ...
            <input id="jiaoshiId" name="jiaoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="增加学分" prop="xuefenjiluNumb">
                       <el-input v-model="ruleForm.xuefenjiluNumb"
                                 placeholder="增加学分" clearable  :readonly="ro.xuefenjiluNumb"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="增加学分" prop="xuefenjiluNumb">
                           <el-input v-model="ruleForm.xuefenjiluNumb"
                                     placeholder="增加学分" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xuefenjiluContent"  label="原因" prop="xuefenjiluContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xuefenjiluContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xuefenjiluContent" label="原因" prop="xuefenjiluContent">
                            <span v-html="ruleForm.xuefenjiluContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    jiaoshiId: false,
                    xuefenjiluNumb: false,
                    xuefenjiluContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                ...
                rules: {
                   ...
                   xuefenjiluNumb: [
                              { required: true, message: '增加学分不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.xuefenjiluContent = _this.ruleForm.xuefenjiluContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.xuefenjiluContent = this.ruleForm.xuefenjiluContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`xuefenjilu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xuefenjiluCrossAddOrUpdateFlag = false;
                                        this.parent.search();
