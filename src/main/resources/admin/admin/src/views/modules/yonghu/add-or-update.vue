               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生名称" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="学生名称" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学生邮箱" prop="yonghuEmail">
                       <el-input v-model="ruleForm.yonghuEmail"
                                 placeholder="学生邮箱" clearable  :readonly="ro.yonghuEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="学分" prop="yonghuXuefen">
                       <el-input v-model="ruleForm.yonghuXuefen"
                                 placeholder="学分" clearable  :readonly="ro.yonghuXuefen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
