        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工号" prop="jiaoshiUuidNumber">
                       <el-input v-model="ruleForm.jiaoshiUuidNumber"
                                 placeholder="工号" clearable  :readonly="ro.jiaoshiUuidNumber"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="教师类型" prop="jiaoshiTypes">
                        <el-select v-model="ruleForm.jiaoshiTypes" :disabled="ro.jiaoshiTypes" placeholder="请选择教师类型">
                            <el-option
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    jiaoshiUuidNumber: new Date().getTime(),
                    username: '',
                    password: '',
                    jiaoshiName: '',
                    jiaoshiPhoto: '',
                ...
                rules: {
                   ...
                   jiaoshiTypes: [
                              { required: true, message: '教师类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
