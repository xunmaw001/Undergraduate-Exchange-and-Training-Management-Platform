    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">本科生交流培养管理平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="教师类型" class="input" v-if="tableName=='jiaoshi'">
                                <el-input v-model="ruleForm.jiaoshiTypes" autocomplete="off" placeholder="教师类型"  />
                           </el-form-item>
                        -->
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // jiaoshi 中的 教师类型 判空处理
                            // if('jiaoshi' == this.tableName && (this.ruleForm.jiaoshiTypes== null ||this.ruleForm.jiaoshiTypes== "")){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/benkeshengjiaoliuguanli/img/back-img-bg.jpg);
