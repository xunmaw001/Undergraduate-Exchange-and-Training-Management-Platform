...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 教师
            //级联表
            JiaoshiEntity jiaoshi = jiaoshiService.selectById(forum.getJiaoshiId());
            if(jiaoshi != null){
...
//                            forumEntity.setYonghuId(Integer.valueOf(data.get(0)));   //学生 要改的
//                            forumEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //教师 要改的
